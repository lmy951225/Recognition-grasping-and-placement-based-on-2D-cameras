...
if __name__ == '__main__':
    ...
    # for i in range(100):
    example_point = np.array([299.921,267.846,550,180,0,0])
    # tcp_pose = np.array([138.496, 280.735 ,450.538 ,180 ,-20.0001, -0.000666101])
    # # tcp_pose = np.array([350.299,69.244,450.549,180,-20,90])
    # # tcp_pose = np.array([354.707,493.711,450.389,180,-19.9998,-90.9986])
    # # tcp_pose = np.array([302.817,141.201,529.276,-179.089,-9.97298,69.8401])
    # # tcp_pose = np.array([254.56,280.292,548.402,-179.209,-4.06645,-1.14113])
    # # tcp_pose = np.array([293.19,179.405,541.975,-179.162,-6.38142,59.1692])
    robotClient.test_MovePose(example_point[0],example_point[1],example_point[2],example_point[3],example_point[4],example_point[5])
    ...
    for idx_loop in range(len(cameraTcppose0)):
        ...
        # firename = '/home/adt/RobotSystem/Sisyphe/TritionModule/models/pose/1/1_1_1_20231127160523701-color.png'
    ...
    # with open('tcp_test_1130_50.txt','a') as f:
    #     for tcp in tcp_50_tcp:
    #         f.writelines(str(tcp))
    #         f.writelines('\n')

    # with open('byd_test_1130_50.txt','a') as f:
